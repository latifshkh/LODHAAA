        ...
        <div className="max-w-[1320px] mx-auto px-6 lg:px-12">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden lg:flex items-center gap-5">
              <button className="text-[9px] tracking-[0.4em] uppercase font-light text-[#1C1610]/40 hover:text-[#B8952A] transition-colors duration-300" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                Enquire
              </button>
              <button className="relative px-6 py-[11px] overflow-hidden group" style={{ background: "linear-gradient(90deg,#B8952A,#D4B96A,#B8952A)", backgroundSize: "200%", fontFamily: "'Montserrat', sans-serif" }}>
        ...
        >
          ...
          <div className="px-7 py-8 flex flex-col gap-1">
            ...
            <div className="flex items-center gap-4 pt-6">
              <button className="flex-1 py-3.5 text-[9px] tracking-[0.45em] uppercase font-medium text-white" style={{ background: "linear-gradient(90deg,#B8952A,#D4B96A,#B8952A)", fontFamily: "'Montserrat', sans-serif" }}>Book Now</button>
              <button className="flex-1 py-3.5 text-[9px] tracking-[0.45em] uppercase font-light text-[#1C1610]/60 border border-[#1C1610]/15 hover:border-[#B8952A]/40 hover:text-[#B8952A] transition-all duration-300" style={{ fontFamily: "'Montserrat', sans-serif" }}>Enquire</button>
            </div>
