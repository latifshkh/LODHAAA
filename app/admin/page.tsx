...
const statusStyle = (s: string) => {
  ...
  if (s === "Limited Units")
    return "text-amber-700 border-amber-400/40 bg-amber-50";
...
const Field = ({
  ...
  <div className="flex flex-col gap-2">
    <label className="flex items-center gap-2">
      <span className="text-[#1C1610]/40 text-[8px] tracking-[0.45em] uppercase font-light">
        {label}
      </span>
...
const SelectField = ({
  ...
  <div className="flex flex-col gap-2">
    <label className="text-[#1C1610]/40 text-[8px] tracking-[0.45em] uppercase font-light">
      {label}
    </label>
    <select
      value={value}
...
export default function AdminPage() {
  ...
  const handleImageUpload = async (file: File) => {
    if (!file) return;
    if (!BUCKET_ID) {
      notify("NEXT_PUBLIC_APPWRITE_BUCKET_ID not set in .env.local", false);
      return;
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      notify("Save failed. Check Appwrite permissions.", false);
    } finally {
      setSaving(false);
    }
  };
  ...
  return (
    ...
    >
      ...
      {toast && (
        <div
          className={`fixed top-6 right-6 z-50 flex items-center gap-3 px-5 py-3.5 border shadow-lg transition-all duration-300
          ${toast.ok ? "border-emerald-400/30 bg-emerald-50 text-emerald-700" : "border-red-300/40 bg-red-50 text-red-600"}`}
        >
          <div
            className={`w-1.5 h-1.5 rounded-full ${toast.ok ? "bg-emerald-500" : "bg-red-500"}`}
          />
        ...
        <div className="max-w-[1320px] mx-auto px-6 lg:px-16 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            {["All Properties", "+ New"].map((label, i) => {
              const active =
                i === 0 ? view === "list" : view === "form" && !editingId;
              return (
                <button
                  key={label}
                  onClick={() =>
      ...
      <div className="max-w-[1320px] mx-auto px-6 lg:px-16 py-14">
        ...
        {view === "form" && (
          <div className="max-w-3xl">
            ...
            <h1
              className="text-[#1C1610] font-light mb-10"
              style={{
                fontFamily: "'Cormorant Garamond', serif",
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-8">
              {/* ── IMAGE UPLOAD ── */}
              <div
                className="border border-[#B8952A]/15 p-8"
                style={{ background: "rgba(245,237,224,0.5)" }}
              >
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-4 h-px bg-[#B8952A]/50" />
                  <p className="text-[#B8952A] text-[8px] tracking-[0.55em] uppercase font-light">
                    Property Image
                  </p>
                </div>
                        ...
                        {uploading ? (
                          <div className="flex gap-1">
                            {[0, 150, 300].map((d) => (
                              <div
                                key={d}
                                className="w-1.5 h-1.5 rounded-full bg-[#B8952A] animate-bounce"
                          ...
                          <>
                            <div className="w-8 h-8 border border-[#B8952A]/30 flex items-center justify-center">
                              <span className="text-[#B8952A]/60 text-lg">
                                +
                              </span>
                            </div>
                            <p className="text-[#1C1610]/30 text-[8px] tracking-[0.4em] uppercase font-light">
                              Upload
                            </p>
                          </>
                        )}
                  ...
                  <div className="flex-1 flex flex-col gap-4">
                    <div>
                      <p className="text-[#1C1610]/50 text-[11px] font-light leading-relaxed">
                        Upload a property image from your device. It will be
                        stored in Appwrite Storage and the URL saved
                        automatically.
                      </p>
              ...
              {/* ── IDENTITY ── */}
              <div
                className="border border-[#B8952A]/12 p-8"
                style={{ background: "rgba(245,237,224,0.5)" }}
              >
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-4 h-px bg-[#B8952A]/50" />
              ...
              {/* ── PREVIEW ── */}
              <div
                className="border border-[#B8952A]/20 overflow-hidden"
              ...
              >
                ...
                <div className="flex gap-0">
                  ...
                  <div
                    ...
                    style={{
                      background: "linear-gradient(160deg,#F0E8D5,#EDE3CC)",
                    }}
                  >
                    {imagePreview ? (
                      <img
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        <p className="text-[#B8952A]/20 text-[8px] tracking-[0.3em] uppercase font-light">
                          No image
                        </p>
                      </div>
                    )}
                  ...
                  <div className="flex-1 p-5 flex flex-col gap-3">
                    <div>
                      ...
                      <p
                        className="text-[#1C1610]/80 font-light mt-1"
                        style={{
                          fontFamily: "'Cormorant Garamond', serif",
                          fontSize: "20px",
                        }}
                    ...
                    <div className="flex items-center gap-4">
                      <div>
                        ...
                        <p
                          className="text-[#1C1610]/70 font-light"
                          style={{
                            fontFamily: "'Cormorant Garamond', serif",
                            fontSize: "16px",
                          }}
                      ...
                      <div>
                        ...
                        <p className="text-[#1C1610]/55 text-[11px] font-light">
                          {form.beds || "—"}
                        </p>
                      </div>
                      {form.status && (
                        <>
                          <div className="w-px h-8 bg-[#B8952A]/15" />
                          <span
                            className={`text-[7px] tracking-[0.4em] uppercase font-light px-2.5 py-1 border ${statusStyle(form.status)}`}
                          >
                            {form.status}
                          </span>
                        </>
              ...
              <div className="flex items-center gap-4 pt-2">
                <button
                  ...
                  style={{
                    background:
                      "linear-gradient(90deg,#B8952A,#D4B96A,#B8952A)",
                    backgroundSize: "200%",
          ...
          <>
            ...
            <div className="flex items-center gap-6 mb-6">
              ...
              <div className="ml-auto flex items-center gap-8">
                {[
                  { label: "Total", val: residences.length },
                  { label: "Shown", val: filtered.length },
                ].map(({ label, val }) => (
                  <div key={label} className="text-right">
                    <p className="text-[#1C1610]/25 text-[7px] tracking-[0.45em] uppercase font-light">
                      {label}
                    </p>
                    <p
                      className="text-[#B8952A] font-light"
                      style={{
                        fontFamily: "'Cormorant Garamond', serif",
                        fontSize: "24px",
                      }}
            ...
            {loading ? (
              <div className="py-20 flex flex-col items-center gap-4">
                ...
                <p className="text-[#1C1610]/25 text-[8px] tracking-[0.45em] uppercase font-light">
                  Loading
                </p>
              </div>
            ) : filtered.length === 0 ? (
                ...
                {filtered.map((r) => (
                  ...
                  >
                    ...
                    >
                      {r.imageUrl ? (
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center gap-2">
                          ...
                          <p className="text-[#B8952A]/30 text-[8px] tracking-[0.4em] uppercase font-light">
                            No Image
                          </p>
                        </div>
                      )}
                      ...
                      <div className="absolute top-3 left-3">
                        <span
                          className={`text-[7px] tracking-[0.4em] uppercase font-light px-2.5 py-1 border ${statusStyle(r.status)}`}
                        >
                          {r.status}
                        </span>
                      </div>
                    ...
                    <div className="p-5">
                      ...
                      <p
                        className="text-[#1C1610]/80 font-light mt-1.5 mb-3"
                        style={{
                          fontFamily: "'Cormorant Garamond', serif",
                          fontSize: "20px",
                        }}
                      ...
                      <div className="flex justify-between items-end mb-4">
                        <div>
                          ...
                          <p
                            className="text-[#1C1610]/70 font-light mt-0.5"
                            style={{
                              fontFamily: "'Cormorant Garamond', serif",
                              fontSize: "17px",
                            }}
            ...
            <div className="mt-6 flex items-center gap-3">
              ...
              <p className="text-[#1C1610]/25 text-[8px] tracking-[0.4em] uppercase font-light">
                {residences.length}{" "}
                {residences.length === 1 ? "property" : "properties"} · changes
                reflect live on /residences
              </p>
            </div>
          </>
        )}
