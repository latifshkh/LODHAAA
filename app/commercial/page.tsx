...
const statusStyle = (s: string) => {
  if (s === "Fully Leased")
    return "text-emerald-700 border-emerald-400/40 bg-emerald-50";
  if (s === "Available")
    return "text-[#B8952A] border-[#B8952A]/35 bg-amber-50";
...
function HeroBanner() {
  ...
  useEffect(() => {
    timer.current = setTimeout(
      () => goTo((current + 1) % BANNER_SLIDES.length),
      5500,
    );
    return () => {
  ...
  return (
    <div
      ...
      style={{ height: "90vh", minHeight: 520, maxHeight: 820 }}
    >
      {/* Background image */}
      <div
        key={current}
      ...
      <div className="relative z-10 h-full max-w-[1320px] mx-auto px-6 lg:px-16 flex flex-col justify-end pb-20 lg:pb-28">
        ...
        >
          {/* Stats glass card */}
          <div
            className="flex items-stretch border border-[#B8952A]/25"
            style={{
          ...
          >
            {[s.stat1, s.stat2].map((st, idx) => (
              ...
              >
                ...
                <p
                  className="text-[#B8952A] text-[8px] tracking-[0.45em] uppercase font-light mt-0.5"
          ...
          <div className="sm:ml-auto flex items-center gap-5">
            <span
              className="text-white/30 text-[9px] tracking-[0.3em]"
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              ...
              {BANNER_SLIDES.map((_, i) => (
                <button
                  ...
                  style={{
                    ...
                    background:
                      i === current ? "#B8952A" : "rgba(255,255,255,0.25)",
                  }}
                >
                  {i === current && (
                    <span
                      className="absolute inset-0 bg-[#D4B96A]"
                      style={{
      ...
      <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 z-10">
        ...
        <span
          className="text-white/20 text-[7px] tracking-[0.5em] uppercase"
          style={{ fontFamily: "'Montserrat', sans-serif" }}
        >
          Scroll
        </span>
    ...
    >
      ...
      <div className="relative pt-40 pb-28 overflow-hidden">
        <div
          className="absolute inset-0"
          style={{
            background: "linear-gradient(135deg,#F0E8D5 0%,#FAF6EF 60%)",
          }}
        />
        ...
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(60deg,rgba(184,149,42,1) 1px,transparent 1px),linear-gradient(-60deg,rgba(184,149,42,1) 1px,transparent 1px)",
        ...
        <div className="relative max-w-[1320px] mx-auto px-6 lg:px-16 grid lg:grid-cols-2 gap-16 items-end">
          <div className="flex flex-col gap-6">
            ...
            <h1
              className="text-[#1C1610] font-light leading-none"
              style={{
                fontFamily: "'Cormorant Garamond', serif",
            ...
            >
              Where Business
              <br />
              <em className="text-[#1C1610]/40">Finds Its Stage</em>
            </h1>
            <p
              className="text-[#1C1610]/45 max-w-md font-light leading-relaxed"
              style={{
                fontFamily: "'Cormorant Garamond', serif",
            ...
            >
              Premium commercial spaces engineered for corporations that refuse
              to compromise on excellence.
            </p>
            <div className="flex gap-4 pt-2">
              <button
                className="px-8 py-3.5 text-[9px] tracking-[0.45em] uppercase font-medium text-white"
                style={{
                  background: "linear-gradient(90deg,#B8952A,#D4B96A,#B8952A)",
                  backgroundSize: "200%",
                  fontFamily: "'Montserrat', sans-serif",
              ...
              <button
                className="px-8 py-3.5 text-[9px] tracking-[0.45em] uppercase font-light text-[#1C1610]/55 border border-[#B8952A]/25 hover:border-[#B8952A]/60 hover:text-[#B8952A] transition-all duration-300"
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
                Leasing Enquiry
              </button>
          ...
          <div className="grid grid-cols-2 gap-px border border-[#B8952A]/15 bg-[#B8952A]/15">
            {SPECS.map(({ label, value, unit }) => (
              <div
                key={label}
                className="px-6 py-7 flex flex-col gap-1 hover:bg-[#F5EDE0] transition-colors duration-500"
                style={{ background: "#FAF6EF" }}
              >
                <p
                  className="text-[#1C1610]/80 font-light leading-none"
                  style={{
                    fontFamily: "'Cormorant Garamond', serif",
                    fontSize: "32px",
                  }}
                ...
                <p className="text-[#B8952A] text-[7px] tracking-[0.45em] uppercase font-light mt-1">
                  {unit}
                </p>
                <p className="text-[#1C1610]/35 text-[9px] tracking-wide font-light">
                  {label}
                </p>
              </div>
            ))}
      ...
      <div className="max-w-[1320px] mx-auto px-6 lg:px-16 py-20">
        <div className="mb-12">
          <p className="text-[#B8952A] text-[8px] tracking-[0.5em] uppercase font-light mb-2">
            Portfolio
          </p>
          <h2
            className="text-[#1C1610]/85 font-light"
            style={{
              fontFamily: "'Cormorant Garamond', serif",
        ...
        <div className="flex flex-col gap-px border border-[#B8952A]/12 bg-[#B8952A]/12">
          {COMMERCIAL.map((p, i) => (
            <div
              key={p.id}
              className="group cursor-pointer transition-colors duration-400"
              ...
              <div className="px-8 py-7 grid grid-cols-12 items-center gap-4">
                <div className="col-span-1">
                  <span
                    ...
                    style={{
                      fontFamily: "'Cormorant Garamond', serif",
                      color: active === p.id ? "#B8952A" : "rgba(28,22,16,0.2)",
                    }}
                  >
                    0{i + 1}
                  </span>
                ...
                <div className="col-span-4">
                  <h3
                    ...
                    style={{
                      ...
                      color:
                        active === p.id ? "#1C1610" : "rgba(28,22,16,0.75)",
                    }}
                  >
                    {p.name}
                  </h3>
                ...
                <div className="col-span-2 hidden md:block">
                  <p className="text-[#1C1610]/30 text-[8px] tracking-[0.3em] uppercase font-light">
                    Type
                  </p>
                  <p className="text-[#1C1610]/60 text-[11px] font-light mt-0.5">
                    {p.type}
                  </p>
                </div>
                <div className="col-span-2 hidden md:block">
                ...
                <div className="col-span-1 flex justify-end">
                  <span
                    className={`text-[7px] tracking-[0.4em] uppercase font-light px-3 py-1.5 border ${statusStyle(p.status)}`}
                  >
                    {p.status}
                  </span>
                </div>
      ...
      <div
        className="border-t border-[#B8952A]/12 py-20"
        style={{ background: "#F5EDE0" }}
      >
        <div className="max-w-[1320px] mx-auto px-6 lg:px-16">
          <div className="text-center mb-12">
            <p className="text-[#B8952A] text-[8px] tracking-[0.5em] uppercase font-light mb-3">
              Why Lodha Commercial
            </p>
            <h2
              className="text-[#1C1610]/80 font-light"
              style={{
                fontFamily: "'Cormorant Garamond', serif",
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-px border border-[#B8952A]/15 bg-[#B8952A]/15">
            {[
              ...
              <div
                key={f}
                className="px-6 py-8 text-center hover:bg-[#FAF6EF] transition-colors duration-400 cursor-default"
                style={{ background: "#F5EDE0" }}
              >
                <div className="w-1.5 h-1.5 bg-[#B8952A]/40 rotate-45 mx-auto mb-3" />
                <p className="text-[#1C1610]/55 text-[9px] tracking-[0.35em] uppercase font-light">
                  {f}
                </p>
              </div>
            ))}
